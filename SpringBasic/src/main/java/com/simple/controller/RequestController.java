...
//	}
	...
	//String형 메서드는 들어가는 경로, 나가는 경로를 각각 지정	
	@RequestMapping("/ex01")
	public String ex01() {
		return "/request/ex01";		
	}
	
	//void형 메서드는 들어오는 경로를 그대로 리졸버 뷰에 반환
//	@RequestMapping("/ex01")
//	public void ex01() {
//	}
	...
	//GET, POST요청 상관없이 둘 다 받아줌
	@RequestMapping("/basic3")
	public void basic3() {
		System.out.println("basic3번 실행");
	}
	
	//동일한 요청을 하나로 맵핑할 때는{경로, ....}로 표기할 수 있다.
...
//		
//		//필수가 아닌 파라미터 required = false속성을 지정
//		//필수가 아닌 파라미터일 경우 null값을 지정하게 되는데 defaultValue로 기본값을 지정할 수 있다.
//		
//		System.out.println(id);
//		System.out.println(age);
